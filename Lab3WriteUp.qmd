...
The shape is different from question 1, the area is the same.
...
The shape is different from question 1 and part(a), the area is the same.
...
Both the shape and the area is different from parts(a) and (b).
